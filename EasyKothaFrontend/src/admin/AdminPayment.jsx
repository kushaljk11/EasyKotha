              ...
              <table className="min-w-full text-left">
                <thead>
                  <tr className="border-b border-gray-100 bg-gray-50/70">
                    <th className="px-6 py-4 text-[10px] font-semibold uppercase tracking-widest text-gray-400">To</th>
                    <th className="px-6 py-4 text-[10px] font-semibold uppercase tracking-widest text-gray-400">By</th>
                    <th className="px-6 py-4 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Date</th>
                    <th className="px-6 py-4 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Amount</th>
                    <th className="px-6 py-4 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Tenant Paid</th>
                    <th className="px-6 py-4 text-[10px] font-semibold uppercase tracking-widest text-gray-400">Admin Release</th>
                  </tr>
                </thead>
                      ...
                      <tr key={transaction.id} className="align-top hover:bg-gray-50/40">
                        <td className="px-6 py-4">
                          <button
                            ...
                            className="text-left"
                          >
                            <div className="text-sm font-semibold text-green-800 hover:underline">
                              {transaction.landlord?.name || "Unknown landlord"}
                            </div>
                            <div className="text-xs text-slate-500 hover:underline">
